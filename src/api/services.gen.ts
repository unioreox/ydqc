...
import type { UpdateApiData, UpdateApiError, UpdateApiResponse, LoginApiData, LoginApiError, LoginApiResponse, ListRecordError, ListRecordResponse, DoCheckinData, DoCheckinError, DoCheckinResponse, GetFeedbackData, GetFeedbackError, GetFeedbackResponse, AddFeedbackData, AddFeedbackError, AddFeedbackResponse, GetWxConfigData, GetWxConfigError, GetWxConfigResponse, InfoApiError, InfoApiResponse, ListTodayValidRecordApiError, ListTodayValidRecordApiResponse, GetLuckyGuyError, GetLuckyGuyResponse, GetLastRecordError, GetLastRecordResponse, ListAllRecordError, ListAllRecordResponse, GetUserCountLeaderBoardError, GetUserCountLeaderBoardResponse, GetTop30UsersByBestScoreError, GetTop30UsersByBestScoreResponse, GetCollegeLeaderBoardError, GetCollegeLeaderBoardResponse, ListCollegeApiError, ListCollegeApiResponse, ListCheckPointError, ListCheckPointResponse, GetCertificateByUserIdApiError, GetCertificateByUserIdApiResponse, GetCertificateByIdApiData, GetCertificateByIdApiError, GetCertificateByIdApiResponse, CancelCheckinData, CancelCheckinError, CancelCheckinResponse } from './types.gen';
...
export const getFeedback = <ThrowOnError extends boolean = false>(options: Options<GetFeedbackData, ThrowOnError>) => { return (options?.client ?? client).get<GetFeedbackResponse, GetFeedbackError, ThrowOnError>({
    ...options,
    url: '/feedback'
}); };

export const addFeedback = <ThrowOnError extends boolean = false>(options: Options<AddFeedbackData, ThrowOnError>) => { return (options?.client ?? client).post<AddFeedbackResponse, AddFeedbackError, ThrowOnError>({
    ...options,
    url: '/feedback'
}); };
...
export const listTodayValidRecordApi = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<ListTodayValidRecordApiResponse, ListTodayValidRecordApiError, ThrowOnError>({
    ...options,
    url: '/record/today'
}); };

export const getLuckyGuy = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetLuckyGuyResponse, GetLuckyGuyError, ThrowOnError>({
    ...options,
    url: '/record/lucky'
}); };
...
export const getCertificateByUserIdApi = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetCertificateByUserIdApiResponse, GetCertificateByUserIdApiError, ThrowOnError>({
    ...options,
    url: '/certificate'
}); };

export const getCertificateByIdApi = <ThrowOnError extends boolean = false>(options: Options<GetCertificateByIdApiData, ThrowOnError>) => { return (options?.client ?? client).get<GetCertificateByIdApiResponse, GetCertificateByIdApiError, ThrowOnError>({
    ...options,
    url: '/certificate/{id}'
}); };

export const cancelCheckin = <ThrowOnError extends boolean = false>(options: Options<CancelCheckinData, ThrowOnError>) => { return (options?.client ?? client).delete<CancelCheckinResponse, CancelCheckinError, ThrowOnError>({
    ...options,
    url: '/record/{recordId}'
}); };