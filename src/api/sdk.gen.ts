...
import type {
    ...
    GetMyTeamPreviewData,
    GetMyTeamPreviewResponse,
    CreateTeamRequestData,
    CreateTeamRequestResponse,
    JoinTeamData,
    JoinTeamResponse,
    ListRecordData,
    ListRecordResponse,
    ...
    DoCheckinResponse,
    ManualAddRecordData,
    ManualAddRecordResponse,
    GetUserFeedbackData,
    GetUserFeedbackResponse,
    AddFeedbackData,
    AddFeedbackResponse,
    UpdatePasswdData,
    UpdatePasswdResponse,
    RefreshTokenData,
    ...
    CancelApplyActivityData,
    CancelApplyActivityResponse,
    ApplyActivityData,
    ...
    InfoApiData,
    InfoApiResponse,
    ExportAllUsersToExcelApiData,
    ExportAllUsersToExcelApiResponse,
    ListAllUserData,
    ListAllUserResponse,
    GetTeamInfoData,
    GetTeamInfoResponse,
    StreamTeamUpdatesData,
    StreamTeamUpdatesResponse,
    ListTodayValidRecordApiData,
    ListTodayValidRecordApiResponse,
    ListTodayValidRecordExcelApiData,
    ListTodayValidRecordExcelApiResponse,
    GetLuckyGuyData,
    GetLuckyGuyResponse,
    DoLuckDrawData,
    DoLuckDrawResponse,
    GetLastRecordData,
    GetLastRecordResponse,
    ListRecordByTimeData,
    ListRecordByTimeResponse,
    ListRecordByTime1Data,
    ListRecordByTime1Response,
    ListAllRecordApiData,
    ListAllRecordApiResponse,
    ListAllValidRecordApiData,
    ListAllValidRecordApiResponse,
    ListAllValidRecordApi1Data,
    ListAllValidRecordApi1Response,
    GetUserCountLeaderBoardData,
    GetUserCountLeaderBoardResponse,
    GetTop30UsersByBestScoreData,
    GetTop30UsersByBestScoreResponse,
    GetCollegeLeaderBoardData,
    GetCollegeLeaderBoardResponse,
    GetHistoryData,
    GetHistoryResponse,
    GetFeedbackData,
    GetFeedbackResponse,
    ListCollegeApiData,
    ListCollegeApiResponse,
    ListCheckPointData,
    ListCheckPointResponse,
    GetCertificateByUserIdApiData,
    GetCertificateByUserIdApiResponse,
    GetCertificateByIdApiData,
    GetCertificateByIdApiResponse,
    GetAsyncRoutesData,
...
export const getReviewContent = <ThrowOnError extends boolean = false>(options: Options<{
    id: string;
    url: "/activities/review/{id}";
}, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<getReviewContentResponse, unknown, ThrowOnError>({
        url: `/activities/review/${options.id}`,
        ...options
    });
};
